        ...
        for epoch in range(args.epochs):
            ...
            while Count * args.batchSize < Xtrain.shape[0]:
                ...
                if args.stage == 1 or args.stage == 0:
                    ...
                    # Training landmarks
                    print(Xtrain[RandomIdx].shape, Ytrain[RandomIdx].shape, Ytrain_em[RandomIdx].shape)
                    ...
                    if args.stage == 1 or args.stage == 0:
                        ...
                        BatchErr, accuracy_train, learn_rate = sess.run(
                            ...
                            {emotionaldan['x']: Xtrain,
                             ...
                             emotionaldan['S1_isTrain']: False,
                             emotionaldan['S2_isTrain']: False})
                        announce = 'Epoch: ' + str(epoch) + ' Batch: ' + str(Count) + ' TestErr: ' + str(
                            TestErr) + ' BatchErr: ' + str(
                            BatchErr) + ' TestAcc: ' + str(accuracy_test) + ' TrainAcc: ' + str(
                            accuracy_train) + ' LR: ' + str(learn_rate) + '\n'
                        print(announce)
